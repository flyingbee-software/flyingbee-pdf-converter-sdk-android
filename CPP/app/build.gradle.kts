...
// Kotlin project (pure Kotlin API).
//
...
val sdkAar = file("../../Shared/libs/flyingbee/FPPDFFramework-10.3.6.aar")
...
dependencies {
    ...
    // all three demos from the repo-root Shared/libs/flyingbee/ folder.
