// ---------------------------------------------------------------------------
// FPPDFFramework_Demo_Android - Android Studio project
//
...
// path see the sibling FPPDFFramework_Demo_Android_CPP project.
//
...
rootProject.name = "FPPDFFrameworkDemoAndroid"
