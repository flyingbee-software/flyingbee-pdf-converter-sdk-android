...
//     app/libs/flyingbee/FPPDFFramework-10.3.6.aar;
...
// AAR), see the sibling FPPDFFramework_Demo_Android_CPP project.
//
...
dependencies {
    // The Flyingbee PDF Conversion SDK, bundled as a direct AAR file. The
